...
async def reject_request(
    ...
    # TODO: Сохранить причину отклонения (можно добавить поле в модель)
    db.commit()
    return None
...
async def get_notifications(
    ...
    Возвращает уведомления для администратора.
    Пока реализовано как простой список на основе данных из БД.
    TODO: Добавить модель Notification в БД для полноценной реализации.
    """
    notifications = []
...
async def mark_notification_read(
    ...
    TODO: Реализовать после добавления модели Notification в БД.
    """
